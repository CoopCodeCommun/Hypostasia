...
| Cadre **violet** | un geste **humain** — et depuis le retrait de la passe de nuit, le 21 septembre 2026, **plus rien ne s'applique sans lui** : `appliquer_un_tour_de_wiki` exige son `fait_par`. |
