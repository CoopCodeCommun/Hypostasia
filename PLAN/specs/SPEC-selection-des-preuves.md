...
**Étalon** : `front/static/front/maquettes/selection-preuves.html`
**Statut** : **SPÉCIFIÉE, NON CODÉE** — la seule des quatre specs canoniques qui
attende encore son code. Aucun template, aucune route, aucune vue : l'écran de
...
Étalon : `front/static/front/maquettes/selection-preuves.html`, dont le moteur JS a été rejoué sous node
